  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/vendors/viewproduct/:id" element={<ProtectedRoute element={VendorProduct} />} />
        ...
        <Route path="/shipping-methods" element={<ProtectedRoute element={Shippingprovider} />} />
